...
def update_part_objects(score_data: dict, part_data: dict, cfg: Configuration, part_features: dict):
    ...
    if part_data[DATA_FAMILY] == VOICE_FAMILY:
        ...
        voice_presence = len(part_data[DATA_SOUNDING_MEASURES])/len(part_data[DATA_MEASURES])
...
def update_score_objects(score_data: dict, parts_data: List[dict], cfg: Configuration, parts_features: List[dict],
    ...
    if voice_parts_data:
        ...
        for part_data in voice_parts_data:
            ...
            features[get_part_feature(part, VOICE_PRESENCE)] = len(part_data[DATA_SOUNDING_MEASURES])/len(part_data[DATA_MEASURES])
