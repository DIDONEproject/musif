...
class FeaturesExtractor:
    ...
    def _get_harmony_data(self, musicxml_file: str) -> dict:
        ...
        if musescore_file_path is None:
            ...
            try:
                data[C.DATA_MUSESCORE_SCORE] = parse_musescore_file(musescore_file_path, self._cfg.expand_repeats)
    ...
    def _deal_with_dupicated_parts(self, parts):
        for part in parts:
            # Keeping violin solo and 1º part of duplicated instruments
    ...
    def _update_parts_module_features(self, module, score_data: dict, parts_data: List[dict],
        ...
        for part_data, part_features in zip(parts_data, parts_features):
            ...
            ldebug(f"Extracting part \"{part_data[C.DATA_PART_ABBREVIATION]}\" {module_name} features.")
            try:
    ...
    def _update_score_module_features(self, module, score_data: dict, parts_data: List[dict],
        ...
        ldebug(f"Extracting score \"{score_data[C.DATA_FILE]}\" {module.__name__} features.")
        try:
