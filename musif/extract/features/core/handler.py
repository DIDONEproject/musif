...
from musif.extract.features.prefix import get_family_feature, get_part_feature, get_score_feature, \
    get_sound_feature
from musif.musicxml import _get_intervals, _get_notes_and_measures, _get_lyrics_in_notes
...
def update_part_objects(score_data: dict, part_data: dict, cfg: Configuration, part_features: dict):
    ...
    notes, tied_notes, measures, sounding_measures, notes_and_rests = _get_notes_and_measures(part)
