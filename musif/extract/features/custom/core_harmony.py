...
def parse_score(mscx_file: str, cfg: Configuration):
    try:
        ...
        cfg.read_logger.error(get_color('ERROR')+"Musescore file was not found for {} file!{}".format(mscx_file, RESET_SEQ))
...
def update_score_objects(score_data: dict, parts_data: List[dict], cfg: Configuration, parts_features: List[dict], score_features: dict):
    score_data["mscx_path"] = find_mscx_file(score_data['file'])
